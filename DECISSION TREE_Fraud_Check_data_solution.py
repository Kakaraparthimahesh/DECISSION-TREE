# -*- coding: utf-8 -*-
"""
Created on Tue Aug 30 23:38:35 2022
...
# By applying gini method we got the accuracy as 78% with max depth 5
# i identified the best max value by working with above forloop

# By applying entropy method we got the accuracy as 75% with max depth 5
# i identified the best max value by working with above forloop
...
# bagging with gini method we could see that same 80% accuracy as consistent
# bagging with entropy method we could see that 80% accuracy as consistent
...
# By applying the Randomforest classifier we could see that 76% accuracy with 60%
