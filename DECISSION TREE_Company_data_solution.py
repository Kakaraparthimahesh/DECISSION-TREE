# -*- coding: utf-8 -*-
"""
Created on Sun Aug 28 15:06:22 2022
...
# By applying gini method we got the accuracy as 76% with max depth 5
# i identified the best max value by working with above forloop

# By applying entropy method we got the accuracy as 84% with max depth 6
# i identified the best max value by working with above forloop
...
# we are getting as 80% accuracy score as the best 
